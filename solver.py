    ...
    def train(self):
        ...
        for epoch in range(self.config.epoch):
            ...
            for i, data_batch in enumerate(self.train_loader):
                ...
                edge_loss_rgbd0=F.binary_cross_entropy_with_logits(sal_edge_rgbd0,sal_edge, reduction='sum')
                edge_loss_rgbd1=F.binary_cross_entropy_with_logits(sal_edge_rgbd1,sal_edge, reduction='sum')
                edge_loss_rgbd2=F.binary_cross_entropy_with_logits(sal_edge_rgbd2,sal_edge, reduction='sum')
                
                sal_loss_fuse = sal_final_loss+1024*edge_loss_rgbd0+1024*edge_loss_rgbd1+1024*edge_loss_rgbd2+sal_loss_coarse_rgb+sal_loss_coarse_depth
